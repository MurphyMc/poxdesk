...
qx.Class.define("poxdesk.ui.window.Taskbar",
{
  ...
  statics :
  {
    getButtonPos : function (button)
    {
      ...
      //var cel = this.__desktop.getLayoutParent().getContentElement().getDomElement();
      ...
      cel = cel.getContentElement().getDomElement();
  ...
  members :
  {
    ...
    __handleMaximize : function (e)
    {
      ...
      zoom.addListener("end", window.maximize, window);
      e.preventDefault();
    },
    ...
    __handleRestore : function (e)
    {
      ...
      zoom.addListener("end", window.restore, window);
      e.preventDefault();
    },
